...
class LoginWidget(QWidget, ui_loginwidget.Ui_loginWidget):
	...
	def __init__(self, widget, parent = None):
		...
		self.setupUi(self)
		self.widget = widget
		self.setStyleSheet("#frameborder-image:url(:login_back.png)"
							"#backButtonborder-image:url(:return0.png)"
							"#backButton:hoverborder-image:url(:return1.png)")
	...
	def testLogin(self):
		...
		pwd = self.passwordEdit.text().toUtf8()
