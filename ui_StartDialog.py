...
#
# Created: Thu Oct 31 04:25:10 2013
...
class Ui_StartDialog(object):
    def setupUi(self, StartDialog):
        ...
        StartDialog.setStyleSheet(_fromUtf8("QFrame#frame{\n"
...
"}"))
        ...
        self.button4.setGeometry(QtCore.QRect(700, 220, 57, 50))
        ...
        self.button5.setGeometry(QtCore.QRect(530, 320, 57, 50))
        ...
        self.button6.setGeometry(QtCore.QRect(640, 340, 57, 50))
        ...
        self.button7.setGeometry(QtCore.QRect(290, 440, 57, 50))
        self.button7.setText(_fromUtf8(""))
        self.button7.setObjectName(_fromUtf8("button7"))
        self.button8 = Ui_ButtonWithDisplay(self.frame)
        self.button8.setEnabled(True)
        self.button8.setGeometry(QtCore.QRect(420, 350, 57, 50))
        self.button8.setText(_fromUtf8(""))
        self.button8.setObjectName(_fromUtf8("button8"))
        self.button9 = Ui_ButtonWithDisplay(self.frame)
        self.button9.setEnabled(True)
        self.button9.setGeometry(QtCore.QRect(30, 360, 57, 50))
        self.button9.setText(_fromUtf8(""))
        self.button9.setObjectName(_fromUtf8("button9"))
        self.button10 = Ui_ButtonWithDisplay(self.frame)
        self.button10.setEnabled(True)
        self.button10.setGeometry(QtCore.QRect(240, 235, 57, 50))
        self.button10.setText(_fromUtf8(""))
        self.button10.setObjectName(_fromUtf8("button10"))
        self.label = QtGui.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(400, 60, 71, 51))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(self.frame)
        self.label_2.setGeometry(QtCore.QRect(500, 160, 71, 51))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(self.frame)
        self.label_3.setGeometry(QtCore.QRect(620, 110, 71, 51))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtGui.QLabel(self.frame)
        self.label_4.setGeometry(QtCore.QRect(700, 260, 71, 51))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.label_5 = QtGui.QLabel(self.frame)
        self.label_5.setGeometry(QtCore.QRect(510, 360, 71, 51))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.label_6 = QtGui.QLabel(self.frame)
        self.label_6.setGeometry(QtCore.QRect(650, 380, 71, 51))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.label_7 = QtGui.QLabel(self.frame)
        self.label_7.setGeometry(QtCore.QRect(220, 460, 71, 51))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.label_8 = QtGui.QLabel(self.frame)
        self.label_8.setGeometry(QtCore.QRect(400, 310, 71, 51))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.label_9 = QtGui.QLabel(self.frame)
        self.label_9.setGeometry(QtCore.QRect(30, 400, 71, 51))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.label_10 = QtGui.QLabel(self.frame)
        self.label_10.setGeometry(QtCore.QRect(300, 230, 81, 51))
        ...
        self.label2.setGeometry(QtCore.QRect(520, 200, 131, 41))
    ...
    def retranslateUi(self, StartDialog):
        ...
        self.label_4.setText(_translate("StartDialog", "Level 4", None))
        self.label_5.setText(_translate("StartDialog", "Level 5", None))
        self.label_6.setText(_translate("StartDialog", "Level 6", None))
        self.label_7.setText(_translate("StartDialog", "Level 7", None))
        self.label_8.setText(_translate("StartDialog", "Level 8", None))
        self.label_9.setText(_translate("StartDialog", "Level 9", None))
        self.label_10.setText(_translate("StartDialog", "Level 10", None))
        ...
        self.label8.setText(_translate("StartDialog", "最高分：", None))
        self.label10.setText(_translate("StartDialog", "最高分：", None))
        self.label9.setText(_translate("StartDialog", "最高分：", None))
