...
UNIT_WIDTH = 50 # width of map grids(1st dimension)
UNIT_HEIGHT = 50 # height of map grids(2nd dimension)
...
LABEL_LEFT_MARGIN = 20 # distance between the item origin and the downleft corner of labels
